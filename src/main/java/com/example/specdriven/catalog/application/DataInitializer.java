...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        List<Movie> movies = movieRepository.saveAll(List.of(
                new Movie("AI Developer 2", "A burnt-out engineer is dragged back for one last impossible release.", 126,
                        "ai-developer-2.png"),
                new Movie("Living in the Forest", "A quiet survival story about rebuilding life far from the city.", 98,
                        "living-in-the-forest.png"),
                new Movie("Pink Elephants", "A glossy comedy where every bad idea somehow gets a bigger budget.", 104,
                        "pink-elephants.png"),
                new Movie("Reindeer Hunter", "A snowbound thriller chasing a rumor through the Arctic night.", 112,
                        "reindeer-hunter.png"),
                new Movie("Sleeping with the Fishes", "Family loyalties get messy when a coastal diner hides secrets.", 117,
                        "sleeping-with-the-fishes.png"),
                new Movie("The Gardening Incident", "A suburban mystery sparked by one very suspicious flowerbed.", 109,
                        "gardening-incident.png"),
                new Movie("The Null Mistake", "A developer drama about one unchecked assumption and the fallout after it.", 101,
                        "null-mistake-java.png"),
                new Movie("Threading a Needle", "A small heist film built on timing, trust, and sharp suits.", 95,
