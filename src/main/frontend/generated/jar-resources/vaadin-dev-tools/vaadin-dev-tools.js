import{LitElement as D,css as j,html as z}from"lit";import{property as V,query as q,state as W,customElement as Z}from"lit/decorators.js";function b(o,e,t,s){var n=arguments.length,r=n<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,t):s,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(o,e,t,s);else for(var l=o.length-1;l>=0;l--)(a=o[l])&&(r=(n<3?a(r):n>3?a(e,t,r):a(e,t))||r);return n>3&&r&&Object.defineProperty(e,t,r),r}class K extends HTMLElement{#o;#n;#e;#s;#t;constructor(){super(),this.#o=null,this.#e=!1,this.#s=null,this.#t=null,this.#n=this.attachShadow({mode:"closed"}),this.render(),this.setupProtection()}static get observedAttributes(){return["expired","start-failure","license-download"]}render(){const e=`
      <style>
        :host {
          position: fixed;
          bottom: 0;
...
<path d="M12 15V9.75H15V15H12ZM7.5 15V3H10.5V15H7.5ZM3 15V6.75H6V15H3Z" fill="url(#paint0_linear_85_186)"/>
    ...
    `,s.appendChild(n),s.addEventListener("secondary-button-click",J),s.addEventListener("primary-button-click",Y),o.innerHTML="<slot></slot>",o.appendChild(s)}},y=(o,e)=>{e&&e.querySelector("vaadin-pretrial")?.setAttribute("start-failure",o?"expired":"")},S=(o,e)=>{e&&e.querySelector("vaadin-pretrial")?.setAttribute("license-download",o)},x=1e3,k=(o,e)=>{const t=Array.from(o.querySelectorAll(e.join(", "))),s=Array.from(o.querySelectorAll("*")).filter(n=>n.shadowRoot).flatMap(n=>k(n.shadowRoot,e));return[...t,...s]};let I=!1;const v=(o,e)=>{I||(window.addEventListener("message",n=>{n.data==="validate-license"&&window.location.reload()},!1),I=!0);const t=o._overlayElement;if(t){if(t.shadowRoot){const n=t.shadowRoot.querySelector("slot:not([name])");if(n&&n.assignedElements().length>0){v(n.assignedElements()[0],e);return}}v(t,e);return}const s=e.messageHtml?e.messageHtml:`${e.message} <p>Component: ${e.product.name} ${e.product.version}</p>`.replace(/https:([^ ]*)/g,"<a href='https:$1'>https:$1</a>");o.isConnected&&(o.outerHTML=`<no-license style="display:flex;align-items:center;text-align:center;justify-content:center;"><div>${s}</div></no-license>`)},g={},_={},m={},M={},h=o=>`${o.name}_${o.version}`,L=o=>{const{cvdlName:e,version:t}=o.constructor,s={name:e,version:t},n=o.tagName.toLowerCase();g[e]=g[e]??[],g[e].push(n);const r=m[h(s)];r&&setTimeout(()=>v(o,r),x),m[h(s)]||M[h(s)]||_[h(s)]||(_[h(s)]=!0,window.Vaadin.devTools.checkLicense(s))},G=o=>{M[h(o)]=!0,console.debug("License check ok for",o)},Q=o=>{const e=o.product.name;m[h(o.product)]=o,console.error("License check failed for",e);const t=g[e];t?.length>0&&k(document,t).forEach(s=>{setTimeout(()=>v(s,m[h(o.product)]),x)})},ee=o=>{const e=o.message,t=o.product.name;o.messageHtml=`No license found. <a target=_blank onclick="javascript:window.open(this.href);return false;" href="${e}">Go here to start a trial or retrieve your license.</a>`,m[h(o.product)]=o,console.error("No license found when checking",t);const s=g[t];s?.length>0&&k(document,s).forEach(n=>{setTimeout(()=>v(n,m[h(o.product)]),x)})},te=(o,e)=>o.command==="license-check-ok"?(G(o.data),!0):o.command==="license-check-failed"?(Q(o.data),!0):o.command==="license-check-nokey"?(X(e,o.data),ee(o.data),!0):o.command==="license-pretrial-started"?(console.debug("Pre-trial period started",o.data),window.location.reload(),!0):o.command==="license-pretrial-expired"?(console.debug("Pre-trial period expired",o.data),y(!0,e),!0):o.command==="license-pretrial-failed"?(console.debug("Pre-trial period start failed",o.data),y(!1,e),!0):o.command==="license-download-completed"?(console.debug("License downloaded"),window.location.reload(),!0):o.command==="license-download-started"?(S("started",e),!0):o.command==="license-download-failed"?(S("failed",e),!0):!1,oe=()=>{window.Vaadin.devTools.startPreTrial()},U=()=>{const o=Object.values(m);o.length>0&&window.Vaadin.devTools.downloadLicense(o[0].product)},se=()=>{window.Vaadin.devTools.createdCvdlElements.forEach(o=>{L(o)}),window.Vaadin.devTools.createdCvdlElements={push:o=>{L(o)}}};var i;(function(o){o.ACTIVE="active",o.INACTIVE="inactive",o.UNAVAILABLE="unavailable",o.ERROR="error"})(i||(i={}));const T=class T{constructor(){this.status=i.UNAVAILABLE}onHandshake(){}onConnectionError(e){}onStatusChange(e){}setActive(e){!e&&this.status===i.ACTIVE?this.setStatus(i.INACTIVE):e&&this.status===i.INACTIVE&&this.setStatus(i.ACTIVE)}setStatus(e){this.status!==e&&(this.status=e,this.onStatusChange(e))}};T.HEARTBEAT_INTERVAL=18e4;let w=T;class ne extends w{constructor(e){super(),this.webSocket=new WebSocket(e),this.webSocket.onmessage=t=>this.handleMessage(t),this.webSocket.onerror=t=>this.handleError(t),this.webSocket.onclose=t=>{this.status!==i.ERROR&&this.setStatus(i.UNAVAILABLE),this.webSocket=void 0},setInterval(()=>{this.webSocket&&self.status!==i.ERROR&&this.status!==i.UNAVAILABLE&&this.webSocket.send("")},w.HEARTBEAT_INTERVAL)}onReload(e){}handleMessage(e){let t;try{t=JSON.parse(e.data)}catch(s){this.handleError(`[${s.name}: ${s.message}`);return}if(t.command==="hello")this.setStatus(i.ACTIVE),this.onHandshake();else if(t.command==="reload"){if(this.status===i.ACTIVE){const s=t.strategy||"reload";this.onReload(s)}}else this.handleError(`Unknown message from the livereload server: ${e}`)}handleError(e){console.error(e),this.setStatus(i.ERROR),e instanceof Event&&this.webSocket?this.onConnectionError(`Error in WebSocket connection to ${this.webSocket.url}`):this.onConnectionError(e)}}const R=16384,A=class A extends w{constructor(e){if(super(),this.canSend=!1,!e)return;const t={transport:"websocket",fallbackTransport:"websocket",url:e,contentType:"application/json; charset=UTF-8",reconnectInterval:5e3,timeout:-1,maxReconnectOnClose:1e7,trackMessageLength:!0,enableProtocol:!0,handleOnlineOffline:!1,executeCallbackBeforeReconnect:!0,messageDelimiter:"|",onMessage:s=>{const n={data:s.responseBody};this.handleMessage(n)},onError:s=>{this.canSend=!1,this.handleError(s)},onOpen:()=>{this.canSend=!0},onClose:()=>{this.canSend=!1},onClientTimeout:()=>{this.canSend=!1},onReconnect:()=>{this.canSend=!1},onReopen:()=>{this.canSend=!0}};re().then(s=>{this.socket=s.subscribe(t)})}onReload(e){}onUpdate(e,t){}onMessage(e){}handleMessage(e){let t;try{t=JSON.parse(e.data)}catch(s){this.handleError(`[${s.name}: ${s.message}`);return}if(t.command==="hello")this.setStatus(i.ACTIVE),this.onHandshake();else if(t.command==="reload"){if(this.status===i.ACTIVE){const s=t.strategy||"reload";this.onReload(s)}}else t.command==="update"?this.status===i.ACTIVE&&this.onUpdate(t.path,t.content):this.onMessage(t)}handleError(e){console.error(e),this.setStatus(i.ERROR),this.onConnectionError(e)}send(e,t){if(!this.socket||!this.canSend){C(()=>this.socket&&this.canSend,a=>this.send(e,t));return}const s=JSON.stringify({command:e,data:t});let r=s.length+"|"+s;for(;r.length;)this.socket.push(r.substring(0,R)),r=r.substring(R)}};A.HEARTBEAT_INTERVAL=18e4;let E=A;function C(o,e){const t=o();t?e(t):setTimeout(()=>C(o,e),50)}function re(){return new Promise((o,e)=>{C(()=>window?.vaadinPush?.atmosphere,o)})}const ie=1,ae="vaadin-refresh-ui";function le(o){if(o.id)return"#"+CSS.escape(o.id);const e=[];let t=o;for(;t&&t!==document.documentElement&&t!==document.body;){if(t.id){e.unshift("#"+CSS.escape(t.id));break}const s=t.parentElement;if(!s)break;let n=1,r=t.previousElementSibling;for(;r;)r.tagName===t.tagName&&n++,r=r.previousElementSibling;e.unshift(t.tagName.toLowerCase()+":nth-of-type("+n+")"),t=s}return e.length>0?e.join(" > "):""}function F(){const o=window.Vaadin;return Object.keys(o?.Flow?.clients||{}).filter(e=>e!=="TypeScript").map(e=>o.Flow.clients[e])}function $(){const o={};return(window.scrollX!==0||window.scrollY!==0)&&(o.__window__={scrollTop:window.scrollY,scrollLeft:window.scrollX}),document.querySelectorAll("*").forEach(e=>{if(e.scrollTop>0||e.scrollLeft>0){const t=le(e);t&&(o[t]={scrollTop:e.scrollTop,scrollLeft:e.scrollLeft})}}),o}function B(o){const e=$();F().forEach(t=>{t.sendEventMessage&&t.sendEventMessage(ie,"ui-refresh",{fullRefresh:o})}),H(e)}let O=!1;function de(){O||(O=!0,window.addEventListener(ae,o=>{B(o.detail?.fullRefresh===!0)}))}function H(o){if(Object.keys(o).length===0)return;const e=200;let t=0;const s=()=>{requestAnimationFrame(()=>{for(const[r,a]of Object.entries(o))if(r==="__window__")window.scrollTo(a.scrollLeft,a.scrollTop);else{const l=document.querySelector(r);l&&(l.scrollTop=a.scrollTop,l.scrollLeft=a.scrollLeft)}})},n=()=>{const r=F();r.length>0&&r.every(l=>!l.isActive())||++t>=e?s():setTimeout(n,50)};setTimeout(n,50)}var c,N;(function(o){o.LOG="log",o.INFORMATION="information",o.WARNING="warning",o.ERROR="error"})(N||(N={}));const P=import.meta.hot?import.meta.hot.hmrClient:void 0;var d;let p=(d=class extends D{constructor(){super(...arguments),this.unhandledMessages=[],this.conf={enable:!1,url:"",contextRelativePath:"",liveReloadPort:-1},this.bodyShadowRoot=null,this.frontendStatus=i.UNAVAILABLE,this.javaStatus=i.UNAVAILABLE,this.componentPickActive=!1,this.nextMessageId=1,this.transitionDuration=0}static get styles(){return[j`
      ...
      `]}static get isActive(){const e=window.sessionStorage.getItem(c.ACTIVE_KEY_IN_SESSION_STORAGE);return e===null||e!=="false"}elementTelemetry(){let e={};try{const t=localStorage.getItem("vaadin.statistics.basket");if(!t)return;e=JSON.parse(t)}catch{return}this.frontendConnection&&this.frontendConnection.send("reportTelemetry",{browserData:e})}openWebSocketConnection(){if(this.frontendStatus=i.UNAVAILABLE,this.javaStatus=i.UNAVAILABLE,!this.conf.token){console.error("Dev tools functionality denied for this host. See Vaadin documentation on how to configure devmode.hostsAllowed property: https://vaadin.com/docs/latest/configuration/properties#properties");return}const e=r=>console.error(r),t=(r="reload")=>{if(r==="refresh"||r==="full-refresh")B(r==="full-refresh");else{const a=$();window.sessionStorage.setItem("vaadin-hotswap-scroll",JSON.stringify(a));const l=window.sessionStorage.getItem(c.TRIGGERED_COUNT_KEY_IN_SESSION_STORAGE),f=l?parseInt(l,10)+1:1;window.sessionStorage.setItem(c.TRIGGERED_COUNT_KEY_IN_SESSION_STORAGE,f.toString()),window.sessionStorage.setItem(c.TRIGGERED_KEY_IN_SESSION_STORAGE,"true"),window.location.reload()}},s=(r,a)=>{const l="context://",f=r.substring(l.length);if(r.startsWith(l)&&(r=this.conf.contextRelativePath+f),a){let u=document.head.querySelector(`style[data-file-path='${r}']`);u||(u=document.createElement("style"),u.setAttribute("data-file-path",r),document.head.appendChild(u),this.removeOldLinks(f)),u.textContent=a,document.dispatchEvent(new CustomEvent("vaadin-theme-updated"))}else if(a===""||a===null){const u=document.head.querySelector(`style[data-file-path='${r}']`);u?u.remove():this.removeOldLinks(f),document.dispatchEvent(new CustomEvent("vaadin-theme-updated"))}},n=new E(this.getDedicatedWebSocketUrl());n.onHandshake=()=>{c.isActive||n.setActive(!1),this.conf.usageStatisticsEnabled===!1?(localStorage.setItem("vaadin.statistics.optout","true"),localStorage.removeItem("vaadin.statistics.basket"),localStorage.removeItem("vaadin.statistics.firstuse")):localStorage.removeItem("vaadin.statistics.optout"),this.elementTelemetry()},n.onConnectionError=e,n.onReload=t,n.onUpdate=s,n.onStatusChange=r=>{this.frontendStatus=r},n.onMessage=r=>this.handleFrontendMessage(r),this.frontendConnection=n,this.conf.backend===c.SPRING_BOOT_DEVTOOLS&&this.conf.liveReloadPort&&(this.javaConnection=new ne(this.getSpringBootWebSocketUrl(window.location)),this.javaConnection.onHandshake=()=>{c.isActive||this.javaConnection.setActive(!1)},this.javaConnection.onReload=t,this.javaConnection.onConnectionError=e,this.javaConnection.onStatusChange=r=>{this.javaStatus=r})}removeOldLinks(e){Array.from(document.head.querySelectorAll('link[rel="stylesheet"]')).forEach(s=>{let n=s.getAttribute("data-file-path")||s.getAttribute("href");n&&n.includes(e)&&s.remove()})}tabHandleMessage(e,t){const s=e;return s.handleMessage&&s.handleMessage.call(e,t)}handleFrontendMessage(e){e.command==="featureFlags"||te(e,this.bodyShadowRoot)||this.handleHmrMessage(e)||this.unhandledMessages.push(e)}handleHmrMessage(e){return e.command!=="hmr"?!1:(P&&P.notifyListeners(e.data.event,e.data.eventData),!0)}getDedicatedWebSocketUrl(){function e(s){const n=document.createElement("div");return n.innerHTML=`<a href="${s}"/>`,n.firstChild.href}if(this.conf.url===void 0)return;const t=e(this.conf.url);if(!t.startsWith("http://")&&!t.startsWith("https://")){console.error("The protocol of the url should be http or https for live reload to work.");return}return`${t}?v-r=push&debug_window&token=${this.conf.token}`}getSpringBootWebSocketUrl(e){const{hostname:t}=e,s=e.protocol==="https:"?"wss":"ws";if(t.endsWith("gitpod.io")){const n=t.replace(/.*?-/,"");return`${s}://${this.conf.liveReloadPort}-${n}`}else return`${s}://${t}:${this.conf.liveReloadPort}`}connectedCallback(){if(super.connectedCallback(),this.bodyShadowRoot=document.body.attachShadow({mode:"closed"}),this.bodyShadowRoot.innerHTML="<slot></slot>",this.conf=window.Vaadin.devToolsConf||this.conf,window.sessionStorage.getItem(c.TRIGGERED_KEY_IN_SESSION_STORAGE)){const r=new Date;`${`0${r.getHours()}`.slice(-2)}${`0${r.getMinutes()}`.slice(-2)}${`0${r.getSeconds()}`.slice(-2)}`,window.sessionStorage.removeItem(c.TRIGGERED_KEY_IN_SESSION_STORAGE)}const t=window.sessionStorage.getItem("vaadin-hotswap-scroll");t!==null&&(window.sessionStorage.removeItem("vaadin-hotswap-scroll"),H(JSON.parse(t))),de(),this.transitionDuration=parseInt(window.getComputedStyle(this).getPropertyValue("--dev-tools-transition-duration"),10);const s=window;s.Vaadin=s.Vaadin||{},s.Vaadin.devTools=Object.assign(this,s.Vaadin.devTools);const n=window.Vaadin;n.devToolsPlugins&&(Array.from(n.devToolsPlugins).forEach(r=>this.initPlugin(r)),n.devToolsPlugins={push:r=>this.initPlugin(r)}),this.openWebSocketConnection(),se()}async initPlugin(e){const t=this;e.init({send:function(s,n){t.frontendConnection.send(s,n)}})}format(e){return e.toString()}checkLicense(e){this.frontendConnection?this.frontendConnection.send("checkLicense",e):G(e)}startPreTrial(){this.frontendConnection?this.frontendConnection.send("startPreTrialLicense",{}):(console.error("Cannot start pre-trial: no connection"),y(!1,this.bodyShadowRoot))}downloadLicense(e){this.frontendConnection?this.frontendConnection.send("downloadLicense",e):S("failed",this.bodyShadowRoot)}setActive(e){this.frontendConnection?.setActive(e),this.javaConnection?.setActive(e),window.sessionStorage.setItem(c.ACTIVE_KEY_IN_SESSION_STORAGE,e?"true":"false")}render(){return z` <div style="display: none" class="dev-tools"></div>`}setJavaLiveReloadActive(e){this.javaConnection?this.javaConnection.setActive(e):this.frontendConnection?.setActive(e)}},c=d,d.DISMISSED_NOTIFICATIONS_IN_LOCAL_STORAGE="vaadin.live-reload.dismissedNotifications",d.ACTIVE_KEY_IN_SESSION_STORAGE="vaadin.live-reload.active",d.TRIGGERED_KEY_IN_SESSION_STORAGE="vaadin.live-reload.triggered",d.TRIGGERED_COUNT_KEY_IN_SESSION_STORAGE="vaadin.live-reload.triggeredCount",d.AUTO_DEMOTE_NOTIFICATION_DELAY=5e3,d.HOTSWAP_AGENT="HOTSWAP_AGENT",d.JREBEL="JREBEL",d.SPRING_BOOT_DEVTOOLS="SPRING_BOOT_DEVTOOLS",d.BACKEND_DISPLAY_NAME={HOTSWAP_AGENT:"HotswapAgent",JREBEL:"JRebel",SPRING_BOOT_DEVTOOLS:"Spring Boot Devtools"},d);b([V({type:String,attribute:!1})],p.prototype,"frontendStatus",void 0);b([V({type:String,attribute:!1})],p.prototype,"javaStatus",void 0);b([q(".window")],p.prototype,"root",void 0);b([W()],p.prototype,"componentPickActive",void 0);p=c=b([Z("vaadin-dev-tools")],p);
