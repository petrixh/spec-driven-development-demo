...
export default function MainLayout() {
  return (
    <AppLayout>
      <div slot="navbar" style={{ display: 'flex', alignItems: 'center', width: '100%', padding: '0 var(--vaadin-gap-l)', gap: 'var(--vaadin-gap-l)' }}>
        ...
        <nav className="resolve-nav" style={{ display: 'flex', gap: 'var(--vaadin-gap-m)' }}>
          <NavLink to="/submit">Submit Ticket</NavLink>
          <NavLink to="/tickets">My Tickets</NavLink>
        </nav>
      </div>
      <div style={{ padding: 'var(--vaadin-gap-l)', maxWidth: '1200px', margin: '0 auto' }}>
        <Outlet />
      </div>
    </AppLayout>
  );
