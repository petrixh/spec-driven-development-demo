...
- [x] Landing page shows movie cards in a responsive grid
- [x] Each card displays poster, title, and duration
- [x] Only movies with future shows appear
- [x] Clicking a card navigates to the movie detail page (`/movie/{id}`)
