...
- Use Vaadin `VerticalLayout` and `HorizontalLayout` with Aura spacing tokens
- Standard spacing: `--vaadin-space-s` (tight), `--vaadin-space-m` (default), `--vaadin-space-l` (sections)
- Max content width: 1200px, centered
- Cards and form sections use `--vaadin-space-m` internal padding
